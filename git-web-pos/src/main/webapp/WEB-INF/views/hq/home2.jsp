		...
		<div class="col-md-3" style="width: 370px">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        ...
                        <div id="progressDiv" class="col-md-8">
                            <section class="panel">
                              <header class="panel-heading">
                                  신규매장 개업 진행상황
                            </header>
                            <div class="panel-body table-responsive">
                              ...
                              <tr>
                                  ...
                                  <td>16.01.26</td>
                                  <!-- <td>$1500</td> -->
                                  <td><span class="label label-success">완공</span></td>
                              ...
                              <tr>
                                  ...
                                  <td>16.02.01</td>
                                  <!-- <td>$2000</td> -->
                                  <td><span class="label label-info">진행중</span></td>
                    ...
                    <ul class="media-list">
                        <li class="media">
                            <a href="#" class="pull-left">
                                <img src="/dobbywebpos/resources/images/user.jpg" alt="Avatar" class="img-circle" width="64" height="64">
                            </a>
