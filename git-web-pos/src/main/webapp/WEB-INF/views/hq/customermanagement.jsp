<%@page import="com.dobbypos.model.dto.Customer"%>
      ...
      <div class="right-side" style="padding-top:25px;text-align:center">
         ...
         <table border="1" style="width:1000px" align="center">
            <tr style="background-color:#999999;height:30px">
               ...
               <th style="width:50px;text-align:center"><spring:message code="hq.customermanagement.phoneNo" /></th>
               <th style="width:50px;text-align:center"><spring:message code="hq.customermanagement.gender" /></th>
               <th style="width:70px;text-align:center"><spring:message code="hq.customermanagement.age" /></th>
               <th style="width:70px;text-align:center"><spring:message code="hq.customermanagement.point" /></th>
               <th style="width:50px;text-align:center"><spring:message code="hq.customermanagement.level" /></th>
               <th style="width:50px;text-align:center"><spring:message code="hq.customermanagement.storeCode" /></th>
            </tr>
